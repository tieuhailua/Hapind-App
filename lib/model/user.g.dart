...
User _$UserFromJson(Map<String, dynamic> json) => User(
      ...
      dob: const TimestampConverter().fromJson(json['dob'] as int?),
      ...
      createTime:
          const TimestampConverter().fromJson(json['createTime'] as int?),
      lastLogin: const TimestampConverter().fromJson(json['lastLogin'] as int?),
